...
app.use('/scripts', express.static(dir + '/bootstrap-colorpicker/dist/'));
app.use('/scripts', express.static(dir + '/bootstrap-daterangepicker'));
app.use('/scripts', express.static(dir + '/angular-daterangepicker/js'));
app.use('/scripts', express.static(dir + '/leaflet/dist'));
...
app.use('/styles', express.static(dir + '/bootstrap-colorpicker/dist/'));
